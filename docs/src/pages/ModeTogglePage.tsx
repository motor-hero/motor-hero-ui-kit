    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Dropdown para alternar entre temas claro, escuro e sistema. Requer ThemeProvider no root da aplicação.
        </p>
      </div>
...
<ModeToggle />`}
      ...
      <div>
        <h2 className="mb-4 text-xl font-semibold">Dependências</h2>
        <div className="rounded-lg border p-4">
          <p className="text-sm text-muted-foreground">
            ...
            funcionar. Certifique-se de que ele está envolvendo sua aplicação.
            Utiliza <code className="rounded bg-muted px-1.5 py-0.5 text-xs font-mono">@radix-ui/react-dropdown-menu</code> e
            ícones do <code className="rounded bg-muted px-1.5 py-0.5 text-xs font-mono">lucide-react</code>.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <PropsTable
          props={[
            { name: "(nenhuma)", type: "\u2014", description: "Este componente não recebe props. Utiliza o useTheme() internamente." },
          ]}
        />
      </div>
    </div>
